const { LoginPolicy } = require("./loginPolicy.class");
const createModel = require("../../models/loginPolicy.model");
const hooks = require("./loginPolicy.hooks");
...
module.exports = function (app) {
  ...
  app.use("/loginPolicy", new LoginPolicy(options, app));

  // Get our initialized service so that we can register hooks
  const service = app.service("loginPolicy");

  // Get the schema of the collections 
  app.get("/loginPolicySchema", function (request, response) {
