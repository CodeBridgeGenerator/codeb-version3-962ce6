const { CloudProviders } = require("./cloudProviders.class");
const createModel = require("../../models/cloudProviders.model");
const hooks = require("./cloudProviders.hooks");
...
module.exports = function (app) {
  ...
  app.use("/cloudProviders", new CloudProviders(options, app));

  // Get our initialized service so that we can register hooks
  const service = app.service("cloudProviders");

  // Get the schema of the collections 
  app.get("/cloudProvidersSchema", function (request, response) {
