const { PasswordPolicy } = require("./passwordPolicy.class");
const createModel = require("../../models/passwordPolicy.model");
const hooks = require("./passwordPolicy.hooks");
...
module.exports = function (app) {
  ...
  app.use("/passwordPolicy", new PasswordPolicy(options, app));

  // Get our initialized service so that we can register hooks
  const service = app.service("passwordPolicy");

  // Get the schema of the collections 
  app.get("/passwordPolicySchema", function (request, response) {
