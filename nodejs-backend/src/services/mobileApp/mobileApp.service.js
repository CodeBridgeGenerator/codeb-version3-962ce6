const { MobileApp } = require("./mobileApp.class");
const createModel = require("../../models/mobileApp.model");
const hooks = require("./mobileApp.hooks");
...
module.exports = function (app) {
  ...
  app.use("/mobileApp", new MobileApp(options, app));

  // Get our initialized service so that we can register hooks
  const service = app.service("mobileApp");

  // Get the schema of the collections 
  app.get("/mobileAppSchema", function (request, response) {
