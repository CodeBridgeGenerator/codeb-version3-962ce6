const { LoginTime } = require("./loginTime.class");
const createModel = require("../../models/loginTime.model");
const hooks = require("./loginTime.hooks");
...
module.exports = function (app) {
  ...
  app.use("/loginTime", new LoginTime(options, app));

  // Get our initialized service so that we can register hooks
  const service = app.service("loginTime");

  // Get the schema of the collections 
  app.get("/loginTimeSchema", function (request, response) {
