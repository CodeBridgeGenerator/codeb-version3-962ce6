const { FrontendApps } = require("./frontendApps.class");
const createModel = require("../../models/frontendApps.model");
const hooks = require("./frontendApps.hooks");
...
module.exports = function (app) {
  ...
  app.use("/frontendApps", new FrontendApps(options, app));

  // Get our initialized service so that we can register hooks
  const service = app.service("frontendApps");

  // Get the schema of the collections 
  app.get("/frontendAppsSchema", function (request, response) {
