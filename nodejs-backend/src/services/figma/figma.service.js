const { Figma } = require("./figma.class");
const createModel = require("../../models/figma.model");
const hooks = require("./figma.hooks");
...
module.exports = function (app) {
  ...
  app.use("/figma", new Figma(options, app));

  // Get our initialized service so that we can register hooks
  const service = app.service("figma");

  // Get the schema of the collections 
  app.get("/figmaSchema", function (request, response) {
