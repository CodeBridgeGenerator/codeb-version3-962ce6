const { Theme } = require("./theme.class");
const createModel = require("../../models/theme.model");
const hooks = require("./theme.hooks");
...
module.exports = function (app) {
  ...
  app.use("/theme", new Theme(options, app));

  // Get our initialized service so that we can register hooks
  const service = app.service("theme");

  // Get the schema of the collections 
  app.get("/themeSchema", function (request, response) {
