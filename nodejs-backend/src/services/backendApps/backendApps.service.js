const { BackendApps } = require("./backendApps.class");
const createModel = require("../../models/backendApps.model");
const hooks = require("./backendApps.hooks");
...
module.exports = function (app) {
  ...
  app.use("/backendApps", new BackendApps(options, app));

  // Get our initialized service so that we can register hooks
  const service = app.service("backendApps");

  // Get the schema of the collections 
  app.get("/backendAppsSchema", function (request, response) {
