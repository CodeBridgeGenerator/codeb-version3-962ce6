const { HighAvailability } = require("./highAvailability.class");
const createModel = require("../../models/highAvailability.model");
const hooks = require("./highAvailability.hooks");
...
module.exports = function (app) {
  ...
  app.use("/highAvailability", new HighAvailability(options, app));

  // Get our initialized service so that we can register hooks
  const service = app.service("highAvailability");

  // Get the schema of the collections 
  app.get("/highAvailabilitySchema", function (request, response) {
