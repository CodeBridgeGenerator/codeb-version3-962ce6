const { DisasterRecovery } = require("./disasterRecovery.class");
const createModel = require("../../models/disasterRecovery.model");
const hooks = require("./disasterRecovery.hooks");
...
module.exports = function (app) {
  ...
  app.use("/disasterRecovery", new DisasterRecovery(options, app));

  // Get our initialized service so that we can register hooks
  const service = app.service("disasterRecovery");

  // Get the schema of the collections 
  app.get("/disasterRecoverySchema", function (request, response) {
