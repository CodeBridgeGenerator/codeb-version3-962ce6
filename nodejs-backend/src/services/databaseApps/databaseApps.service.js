const { DatabaseApps } = require("./databaseApps.class");
const createModel = require("../../models/databaseApps.model");
const hooks = require("./databaseApps.hooks");
...
module.exports = function (app) {
  ...
  app.use("/databaseApps", new DatabaseApps(options, app));

  // Get our initialized service so that we can register hooks
  const service = app.service("databaseApps");

  // Get the schema of the collections 
  app.get("/databaseAppsSchema", function (request, response) {
