const { IOtApp } = require("./iOtApp.class");
const createModel = require("../../models/iOtApp.model");
const hooks = require("./iOtApp.hooks");
...
module.exports = function (app) {
  ...
  app.use("/iOtApp", new IOtApp(options, app));

  // Get our initialized service so that we can register hooks
  const service = app.service("iOtApp");

  // Get the schema of the collections 
  app.get("/iOtAppSchema", function (request, response) {
