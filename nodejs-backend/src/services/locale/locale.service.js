const { Locale } = require("./locale.class");
const createModel = require("../../models/locale.model");
const hooks = require("./locale.hooks");
...
module.exports = function (app) {
  ...
  app.use("/locale", new Locale(options, app));

  // Get our initialized service so that we can register hooks
  const service = app.service("locale");

  // Get the schema of the collections 
  app.get("/localeSchema", function (request, response) {
