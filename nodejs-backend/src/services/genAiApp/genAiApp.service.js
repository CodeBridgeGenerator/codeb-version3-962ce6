const { GenAiApp } = require("./genAiApp.class");
const createModel = require("../../models/genAiApp.model");
const hooks = require("./genAiApp.hooks");
...
module.exports = function (app) {
  ...
  app.use("/genAiApp", new GenAiApp(options, app));

  // Get our initialized service so that we can register hooks
  const service = app.service("genAiApp");

  // Get the schema of the collections 
  app.get("/genAiAppSchema", function (request, response) {
