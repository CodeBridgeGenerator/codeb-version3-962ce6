const { Sharing } = require("./sharing.class");
const createModel = require("../../models/sharing.model");
const hooks = require("./sharing.hooks");
...
module.exports = function (app) {
  ...
  app.use("/sharing", new Sharing(options, app));

  // Get our initialized service so that we can register hooks
  const service = app.service("sharing");

  // Get the schema of the collections 
  app.get("/sharingSchema", function (request, response) {
