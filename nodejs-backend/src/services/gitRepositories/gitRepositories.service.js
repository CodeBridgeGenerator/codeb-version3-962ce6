const { GitRepositories } = require("./gitRepositories.class");
const createModel = require("../../models/gitRepositories.model");
const hooks = require("./gitRepositories.hooks");
...
module.exports = function (app) {
  ...
  app.use("/gitRepositories", new GitRepositories(options, app));

  // Get our initialized service so that we can register hooks
  const service = app.service("gitRepositories");

  // Get the schema of the collections 
  app.get("/gitRepositoriesSchema", function (request, response) {
