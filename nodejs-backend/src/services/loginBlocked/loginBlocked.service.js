const { LoginBlocked } = require("./loginBlocked.class");
const createModel = require("../../models/loginBlocked.model");
const hooks = require("./loginBlocked.hooks");
...
module.exports = function (app) {
  ...
  app.use("/loginBlocked", new LoginBlocked(options, app));

  // Get our initialized service so that we can register hooks
  const service = app.service("loginBlocked");

  // Get the schema of the collections 
  app.get("/loginBlockedSchema", function (request, response) {
