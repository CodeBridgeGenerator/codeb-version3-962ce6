...
import seederData from "./mobileApp.seeder.json";
...
const MobileAppSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(MobileAppSeederDialogComponent);
