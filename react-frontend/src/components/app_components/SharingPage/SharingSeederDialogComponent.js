...
import seederData from "./sharing.seeder.json";
...
const SharingSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(SharingSeederDialogComponent);
