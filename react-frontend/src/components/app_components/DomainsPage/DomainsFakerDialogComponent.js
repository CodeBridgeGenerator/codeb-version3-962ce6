...
client.service("environments")
    ...
    const onRun = async () => {
        let fakeData = domainsFakerFactory(props.user,fakerCount,projectIdIds,environmentIds);
...
export default connect(mapState, mapDispatch)(DomainsFakerDialogComponent);
