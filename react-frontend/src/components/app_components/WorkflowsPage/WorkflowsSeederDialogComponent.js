...
import seederData from "./workflows.seeder.json";
...
const WorkflowsSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(WorkflowsSeederDialogComponent);
