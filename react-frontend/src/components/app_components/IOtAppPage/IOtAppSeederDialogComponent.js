...
import seederData from "./iOtApp.seeder.json";
...
const IOtAppSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(IOtAppSeederDialogComponent);
