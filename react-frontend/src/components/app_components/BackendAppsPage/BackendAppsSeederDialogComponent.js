...
import seederData from "./backendApps.seeder.json";
...
const BackendAppsSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(BackendAppsSeederDialogComponent);
