...
import seederData from "./disasterRecovery.seeder.json";
...
const DisasterRecoverySeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(DisasterRecoverySeederDialogComponent);
