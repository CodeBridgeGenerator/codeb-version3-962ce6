...
import seederData from "./loginBlocked.seeder.json";
...
const LoginBlockedSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(LoginBlockedSeederDialogComponent);
