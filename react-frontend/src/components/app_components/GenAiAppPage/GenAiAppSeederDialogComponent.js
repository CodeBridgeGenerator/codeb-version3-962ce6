...
import seederData from "./genAiApp.seeder.json";
...
const GenAiAppSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(GenAiAppSeederDialogComponent);
