...
import seederData from "./locale.seeder.json";
...
const LocaleSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(LocaleSeederDialogComponent);
