...
import seederData from "./passwordPolicy.seeder.json";
...
const PasswordPolicySeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(PasswordPolicySeederDialogComponent);
