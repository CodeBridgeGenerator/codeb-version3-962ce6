...
import seederData from "./gitRepositories.seeder.json";
...
const GitRepositoriesSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(GitRepositoriesSeederDialogComponent);
