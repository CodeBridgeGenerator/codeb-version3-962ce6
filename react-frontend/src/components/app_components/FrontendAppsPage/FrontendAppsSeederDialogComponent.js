...
import seederData from "./frontendApps.seeder.json";
...
const FrontendAppsSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(FrontendAppsSeederDialogComponent);
