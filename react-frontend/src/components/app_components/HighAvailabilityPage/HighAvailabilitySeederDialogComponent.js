...
import seederData from "./highAvailability.seeder.json";
...
const HighAvailabilitySeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(HighAvailabilitySeederDialogComponent);
