...
import seederData from "./loginPolicy.seeder.json";
...
const LoginPolicySeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(LoginPolicySeederDialogComponent);
