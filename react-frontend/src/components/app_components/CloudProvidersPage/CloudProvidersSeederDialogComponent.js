...
import seederData from "./cloudProviders.seeder.json";
...
const CloudProvidersSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(CloudProvidersSeederDialogComponent);
