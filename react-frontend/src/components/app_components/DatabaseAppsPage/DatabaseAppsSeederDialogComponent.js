...
import seederData from "./databaseApps.seeder.json";
...
const DatabaseAppsSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(DatabaseAppsSeederDialogComponent);
