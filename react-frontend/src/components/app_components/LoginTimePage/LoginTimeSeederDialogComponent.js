...
import seederData from "./loginTime.seeder.json";
...
const LoginTimeSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(LoginTimeSeederDialogComponent);
